        ...
        if USE_MULTI_ASPECT and query_text.strip():
            ...
            for aq in aspect_queries:
                ...
                try:
                    ...
                    logger.warning(f"[QA_MODE] Ошибка aspect-поиска '{aq[:40]}...': {e}")
